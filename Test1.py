...
for i in range(1,4): #df['Link'].count()+1
    browser.get(df['Link'][i])

    try:
        image_element = browser.find_element(By.CSS_SELECTOR, ":is(#chegg-main-content > div:nth-child(1) > section > div > div > p > img:nth-child(1), #mobile-question-style > div:nth-child(1) > img:nth-child(1), #chegg-main-content > div:nth-child(1) > section > div > p > img:nth-child(1))")
    except:
        continue
